...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        .name = COMPOUND_STRING("Silly Slap"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BIND] =
    {
        ...
        .power = 15,
        .type = TYPE_NORMAL,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_5 ? 85 : 75,
        .pp = 20,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_THRASH] =
    {
        ...
        .accuracy = 100,
        .pp = 12,
        .target = TARGET_SELECTED, //TARGET_RANDOM,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .instructBanned = TRUE,
    ...
    [MOVE_PIN_MISSILE] =
    {
        ...
        .type = TYPE_BUG,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_6 ? 95 : 85,
        .pp = 20,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_SPITFIRE] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = COMBO_STARTER_SPITFIRE,
    ...
    [MOVE_THUNDER_WAVE] =
    {
        ...
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_7 ? 90 : 100,
        .pp = 20,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_LIGHT_SCREEN] =
    {
        ...
        .accuracy = 0,
        .pp = 20,
        .target = TARGET_USER_OR_ALLY, //TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_SPDEF_UP_1 },
        .ignoresProtect = TRUE,
    ...
    [MOVE_SLUDGE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_POISON,
            .chance = 50, //B_UPDATED_MOVE_DATA >= GEN_2 ? 30 : 40,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_CONSTRICT] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = 100, //B_UPDATED_MOVE_DATA >= GEN_2 ? 10 : 33,
        }),
    ...
    [MOVE_CRABHAMMER] =
    {
        ...
        .type = TYPE_WATER,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_5 ? 95 : 85,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
        .pp = 12,
        .target = TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_SHARPEN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "and raises Attack."),
        .effect = EFFECT_ATTACK_SPATK_UP, //EFFECT_ATTACK_UP,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_BONE_RUSH] =
    {
        ...
        .power = 25,
        .type = TYPE_GROUND,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 80,
        .pp = 12,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_RETURN] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack that shows the\n"
            "user's close friendship."),
        .effect = EFFECT_HIT, //EFFECT_RETURN,
        .power = 100, //1,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_DRAGON_BREATH] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_DRAGON_DANCE, COMBO_STARTER_SPITFIRE, COMBO_STARTER_DRAGON_RUSH, COMBO_STARTER_DRAGON_TAIL},
    ...
    [MOVE_POISON_FANG] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = 100, //B_UPDATED_MOVE_DATA >= GEN_6 ? 50 : 30,
        }),
    ...
    [MOVE_DRAGON_CLAW] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DRAGON_BREATH, COMBO_STARTER_DRAGON_DANCE, COMBO_STARTER_SPITFIRE, COMBO_STARTER_DRAGON_RUSH, COMBO_STARTER_DRAGON_TAIL},
    ...
    [MOVE_DRAGON_DANCE] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_DRAGON_BREATH, COMBO_STARTER_SPITFIRE, COMBO_STARTER_DRAGON_RUSH, COMBO_STARTER_DRAGON_TAIL},
    ...
    [MOVE_ROCK_BLAST] =
    {
        ...
        .power = 25,
        .type = TYPE_ROCK,
        .accuracy = 95, //B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 80,
        .pp = 12,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_DRAGON_RUSH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Also hurts the user."),
        .effect = EFFECT_RECOIL, //EFFECT_HIT,
        .power = 120, //100,
        .type = TYPE_DRAGON,
        .accuracy = 90, //75,
        .pp = 12,
        ...
        .contestComboMoves = {COMBO_STARTER_DRAGON_BREATH, COMBO_STARTER_DRAGON_DANCE, COMBO_STARTER_SPITFIRE, COMBO_STARTER_DRAGON_TAIL},
    ...
    [MOVE_MAGMA_STORM] =
    {
        ...
        .type = TYPE_FIRE,
        .accuracy = 90, //B_UPDATED_MOVE_DATA >= GEN_5 ? 75 : 70,
        .pp = 8,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_DRAGON_TAIL] =
    {
        ...
        .contestComboMoves = {COMBO_STARTER_DRAGON_BREATH, COMBO_STARTER_DRAGON_DANCE, COMBO_STARTER_SPITFIRE, COMBO_STARTER_DRAGON_RUSH, COMBO_STARTER_STEALTH_ROCK, COMBO_STARTER_SPIKES, COMBO_STARTER_TOXIC_SPIKES},
    ...
    [MOVE_SPARKLING_ARIA] =
    {
        ...
        .accuracy = 100,
        .pp = 12,
        .target = TARGET_BOTH, //TARGET_FOES_AND_ALLY,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_GLITZY_GLOW] =
    {
        ...
        .type = TYPE_PSYCHIC,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_8 ? 95 : 100,
        .pp = 16,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 100, //B_UPDATED_MOVE_DATA >= GEN_9 ? 90 : 50,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 12,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
