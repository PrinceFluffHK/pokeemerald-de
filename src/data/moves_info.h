...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_THRASH] =
    {
        ...
        .pp = 10,
        .target = MOVE_TARGET_SELECTED, //MOVE_TARGET_RANDOM,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .instructBanned = TRUE,
    ...
    [MOVE_DRAGON_RAGE] =
    {
        .name = COMPOUND_STRING("Drake Flare"),
        .description = COMPOUND_STRING(
            "Launches shock waves that\n"
    ...
    [MOVE_ROCK_THROW] =
    {
        ...
        .power = 50,
        .type = TYPE_ROCK,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_2 ? 90 : 65,
        // .pp = 15,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_SHARPEN] =
    {
        ...
        // .pp = 30,
        .pp = 10,
        .target = MOVE_TARGET_USER | MOVE_TARGET_ALLY, //MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_ATK_UP_1 },
        .snatchAffected = TRUE,
    ...
    [MOVE_SWAGGER] =
    {
        ...
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 100, //B_UPDATED_MOVE_DATA >= GEN_7 ? 85 : 90,
        // .pp = 15,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_HIDDEN_POWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "vary with the user."),
        #endif
        .power = 80, //B_HIDDEN_POWER_DMG >= GEN_6 ? 60 : 1,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .makesContact = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEF_MINUS_2, //MOVE_EFFECT_DEF_MINUS_1,
            .chance = 100, //50,
        }),
    ...
    [MOVE_POISON_TAIL] =
    {
        ...
        // .pp = 25,
        .pp = 10,
        .target = MOVE_TARGET_BOTH, //SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
    ...
    [MOVE_ALLY_SWITCH] =
    {
        ...
        .pp = 10,
        .target = MOVE_TARGET_USER,
        .priority = 0, //B_UPDATED_MOVE_DATA >= GEN_7 ? 2 : 1,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_SPD_UP_2 },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
    ...
    [MOVE_SPARKLING_ARIA] =
    {
        ...
        // .pp = 10,
        .pp = 10,
        .target = MOVE_TARGET_BOTH, //MOVE_TARGET_FOES_AND_ALLY,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_GLITZY_GLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 50, //B_UPDATED_MOVE_DATA >= GEN_8 ? 80 : 90,
        .type = TYPE_PSYCHIC,
    ...
    [MOVE_SAPPY_SEED] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 50, //B_UPDATED_MOVE_DATA >= GEN_8 ? 100 : 90,
        .type = TYPE_GRASS,
