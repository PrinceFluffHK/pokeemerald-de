...
#if defined(FIRERED)
    { COMPOUND_STRING("SHROOMISH{CLEAR_TO 0x55}{FONT_SMALL} 180 COINS") },
    { COMPOUND_STRING("DUCKLETT{CLEAR_TO 0x55}{FONT_SMALL} 500 COINS") },
    { COMPOUND_STRING("LITWICK{CLEAR_TO 0x4B}{FONT_SMALL} 2,800 COINS") },
    { COMPOUND_STRING("HONEDGE{CLEAR_TO 0x4B}{FONT_SMALL} 5,500 COINS") },
    { COMPOUND_STRING("PAWNIARD{CLEAR_TO 0x4B}{FONT_SMALL} 9,999 COINS") },
#else
...
static const struct MenuAction sMultichoiceList_GameCornerTMPrizes[] = {
    { COMPOUND_STRING("TM51{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS") },
    { COMPOUND_STRING("TM52{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS") },
    { COMPOUND_STRING("TM53{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS") },
    { COMPOUND_STRING("TM54{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS") },
    { COMPOUND_STRING("Mega Ring{CLEAR_TO 0x48}{FONT_SMALL}9,999 COINS") },
    { sText_NoThanks }
};

static const struct MenuAction sMultichoiceList_GameCornerBattleItemPrizes[] = {
    { COMPOUND_STRING("LUCKY PUNCH{CLEAR_TO 0x5A}{FONT_SMALL}200 COINS") },
    { COMPOUND_STRING("LEEK{CLEAR_TO 0x50}{FONT_SMALL}1,000 COINS") },
    { COMPOUND_STRING("THICK CLUB{CLEAR_TO 0x50}{FONT_SMALL}1,000 COINS") },
    { COMPOUND_STRING("LIGHT BALL{CLEAR_TO 0x50}{FONT_SMALL}1,600 COINS") },
    { COMPOUND_STRING("BERSERK GENE{CLEAR_TO 0x50}{FONT_SMALL}3,800 COINS") },
    { sText_NoThanks }
};
