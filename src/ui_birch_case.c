...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_TOP_FIRST]        = {SPECIES_DRATINI, 2, ITEM_EXP_SHARE, BALL_POKE},
    [BALL_TOP_SECOND]       = {SPECIES_LARVITAR, 2, ITEM_EXP_SHARE, BALL_POKE},
    [BALL_TOP_THIRD]        = {SPECIES_DEINO, 2, ITEM_EXP_SHARE, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_GOOMY, 2, ITEM_EXP_SHARE, BALL_POKE},
    
    [BALL_MIDDLE_FIRST]     = {SPECIES_JANGMO_O, 2, ITEM_EXP_SHARE, BALL_POKE},
    [BALL_MIDDLE_SECOND]    = {SPECIES_DREEPY, 2, ITEM_EXP_SHARE, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_FRIGIBAX, 2, ITEM_EXP_SHARE, BALL_POKE},

    [BALL_BOTTOM_FIRST]     = {SPECIES_MELTAN, 2, ITEM_EXP_SHARE, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_BELDUM, 2, ITEM_EXP_SHARE, BALL_REPEAT},
