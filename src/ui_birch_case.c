...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_TOP_FIRST]        = {SPECIES_DRATINI, 2, ITEM_EXP_SHARE, BALL_CHERISH},
    [BALL_TOP_SECOND]       = {SPECIES_LARVITAR, 2, ITEM_EXP_SHARE, BALL_CHERISH},
    [BALL_TOP_THIRD]        = {SPECIES_LARVESTA, 2, ITEM_EXP_SHARE, BALL_CHERISH},
    [BALL_TOP_FOURTH]       = {SPECIES_DEINO, 2, ITEM_EXP_SHARE, BALL_CHERISH},
    
    [BALL_MIDDLE_FIRST]     = {SPECIES_GOOMY, 2, ITEM_EXP_SHARE, BALL_CHERISH},
    [BALL_MIDDLE_SECOND]    = {SPECIES_JANGMO_O, 2, ITEM_EXP_SHARE, BALL_CHERISH},
    [BALL_MIDDLE_THIRD]     = {SPECIES_MELTAN, 2, ITEM_EXP_SHARE, BALL_CHERISH},

    [BALL_BOTTOM_FIRST]     = {SPECIES_DREEPY, 2, ITEM_EXP_SHARE, BALL_CHERISH},
    [BALL_BOTTOM_SECOND]    = {SPECIES_FRIGIBAX, 2, ITEM_EXP_SHARE, BALL_CHERISH},
...
static const u8 sText_AreYouSure[] = _("You want that one?    {A_BUTTON} Yes  {B_BUTTON} No");
