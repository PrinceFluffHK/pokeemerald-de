...
static const u8 gText_TextSpeedFast[]       = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INST");
...
static const u8 *const sOptionMenuItemsNames[MENUITEM_COUNT] =
{
    ...
    [MENUITEM_BATTLESTYLE] = COMPOUND_STRING("TURN PREVIEW"),
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tBattleStyle = gSaveBlock2Ptr->optionsPreviewStyle;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsPreviewStyle = gTasks[taskId].tBattleStyle;
